...
Explicit;
Ex;
var a = "hello frind my name anil";
a = 12;
Error in type;
Assignment;
value;
...
any;
doesn;
't know what type of data it can be "any" thing..;
var json = JSON.parse("5");
...
'readonly [number, boolean, string]'.
    ourTupl = [8, false, 'di', 4, '55', true];
error;
TS2322: Type;
'[number, false, string, number, string, true]';
is;
not;
assignable;
to;
